...
class LocationDbUseCaseImpl @Inject constructor(private val locationRepository: LocationRepository) :
    LocationDbUseCase {
    ...
    override suspend fun addLocationList(locationEntity: List<LocationEntity>) =
        locationRepository.addLocationList(locationEntity)

    override suspend fun deleteItem(cityName: String) = locationRepository.deleteLocation(cityName)
